...
FIXTURE(StringUtilsSpec) 
{
  ...
  TEST("numeric string: start with digit and end with digit")
  {
    ...
    ASSERT_THAT(compare("2\\A\\A2", "9152"), eq(0));
  ...
  TEST("numeric string: start with escape letter and end with escape letter")
  {
    ...
    ASSERT_THAT(compare("\\A22\\A", "65285"), eq(-1));
  ...
  // {
  //   ASSERT_THAT(compare("555*ddd", "555*ddd"), thrown(IllegalArgumentException));
  // }

  // TEST("invalid escape digits")
  // {
  //   ASSERT_THAT(compare("a\\*a", "a\\*a"), thrown(IllegalArgumentException));
  // }

  // TEST("invalid escape letters")
  // {
  //   ASSERT_THAT(compare("5\\*5", "5\\*5"), thrown(IllegalArgumentException));
  // }

  // TEST("same head, but tail contains invalid chars")
  // {
  //   ASSERT_THAT(compare("aaa123aaa123", "aaa123aaa123***"), thrown(IllegalArgumentException));
  // }
}
